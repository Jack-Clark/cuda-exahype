...
#ifndef EXAHYPE_ADAPTERS_LimiterStatusMergingMPI_H_
#define EXAHYPE_ADAPTERS_LimiterStatusMergingMPI_H_
 ...
 */
class exahype::adapters::LimiterStatusMergingMPI {
  private:
    typedef mappings::LimiterStatusMergingMPI Mapping0;

     Mapping0  _map2LimiterStatusMergingMPI;
