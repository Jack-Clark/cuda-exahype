...
#ifndef EXAHYPE_ADAPTERS_PlotAugmentedAMRGrid_H_
#define EXAHYPE_ADAPTERS_PlotAugmentedAMRGrid_H_
...
class exahype::adapters::PlotAugmentedAMRGrid {
  ...
  public:
    ...
    PlotAugmentedAMRGrid();

    #if defined(SharedMemoryParallelisation)
    PlotAugmentedAMRGrid(const PlotAugmentedAMRGrid& masterThread);
    #endif

    virtual ~PlotAugmentedAMRGrid();
  
    #if defined(SharedMemoryParallelisation)
    void mergeWithWorkerThread(const PlotAugmentedAMRGrid& workerThread);
    #endif
