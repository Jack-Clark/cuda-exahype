...
#ifndef EXAHYPE_MAPPINGS_PostProcessing_H_
#define EXAHYPE_MAPPINGS_PostProcessing_H_
...
/**
 * Calls post-processing routines of the
 * solvers in the leaveCell(...)-event.
 *
 * @author Dominic Charrier
 */
class exahype::mappings::PostProcessing {
public:
 private:
  /**
...
static void sendEmptySolverDataToNeighbour(
 ...
 public:
  ...
  PostProcessing();
    ...
    * Nop.
    */
  PostProcessing(const PostProcessing& masterThread);
  #endif

  /**
   * Call the postProcess(...) for every solver that has registered
  ...
  void mergeWithWorker(exahype::Vertex& localVertex,
    ...
    * Nop.
    */
   void mergeWithWorkerThread(const PostProcessing& workerThread);
 #endif
   /**
    * Nop.
    */
