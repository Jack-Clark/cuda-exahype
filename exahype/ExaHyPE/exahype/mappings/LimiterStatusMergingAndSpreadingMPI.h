...
#ifndef EXAHYPE_MAPPINGS_LimiterStatusMergingAndSpreadingMPI_H_
#define EXAHYPE_MAPPINGS_LimiterStatusMergingAndSpreadingMPI_H_
 ...
 */
class exahype::mappings::LimiterStatusMergingAndSpreadingMPI {
 private:
  /**
